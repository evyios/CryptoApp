...
extension PortfolioView {
    ...
    private func updateSelectedoin(coin: CoinModel  ) {
        selectedCoin = coin
    ...
    private var portfolioInputSection: some View {
        VStack(spacing: 20) {
            HStack {
                Text("Current price at \(selectedCoin?.symbol.uppercased() ?? "") :")
                Spacer()
    ...
    private func saveButtonPressed() {
        //check that we do have a coin that we are selected
        guard
